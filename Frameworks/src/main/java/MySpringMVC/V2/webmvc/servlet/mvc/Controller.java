 ...
 * {@link #handleRequest(Method, Object[]) handleRequest}
...
public interface Controller {
     ...
     *
     * @param method current HTTP request
     * @param args   current HTTP response
     * @return a ModelAndView to render, or {@code null} if handled directly
     * @throws Exception in case of errors
     */
    ModelAndView handleRequest(Method method, Object[] args) throws Exception;
